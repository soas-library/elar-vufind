...
$config = [
    'controllers' => [
        'invokables' => [
            ...
            'resource' => 'VuFindConsole\Controller\ResourceController',
            'latlogs' => 'VuFindConsole\Controller\LatLogsController',
            'update' => 'VuFindConsole\Controller\UpdateController',
