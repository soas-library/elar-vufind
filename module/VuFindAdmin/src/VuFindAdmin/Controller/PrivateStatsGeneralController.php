 ...
 * @link     http://vufind.org   Main Site
 */
class PrivateStatsGeneralController extends AbstractAdmin
{
    /**
	...
	if (isset($_POST['btnExportarExcel'])){
        ...
        $view->setTemplate('admin/privatestatsgeneral/home');
	...
	//  XLS file
	$objSheet ->getCell('A'.$contador)->setValue('"'.$this->translate('Month'). '","' .$this->translate('Year'). '","' .$this->translate('page hits'). '","' .$this->translate('user logins'). '","' .$this->translate('files with O access').'","' .$this->translate('files with U access').'","' .$this->translate('files with S access').'","' .$this->translate('clics_per_visit').'","' .$this->translate('duration_of_visit').'"');
