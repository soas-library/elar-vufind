...
class Entry extends ParentEntry
{
    ...
    public function render()
    {
        ...
        //SCB Description
        $this->setDCDescription($this->dom, $this->base);
        //SCB Description
     ...
     * @return void
     */
    protected function setDCDescription(DOMDocument $dom, DOMElement $root)
    {
        $dcDescription = $this->getDataContainer()->getDCDescription();
        $final ="";
        foreach ($dcDescription as $description) {
            $final = $final . " " . $description;
        }
        $dcDescription = trim($description);
        if (empty($dcDescription)) {
            return;
        }
        $description = $this->dom->createElement('dc:description');
        $text = $dom->createTextNode($dcDescription);
