...
/**
 * VuFind Driver for Amicus (version: 3.02)
 *
 * @category VuFind2
 * @package  ILS_Drivers
 * @author   Altaf Mahmud, System Programmer <altaf.mahmud@gmail.com>
...
class Amicus extends AbstractBase
{
    ...
    public function init()
    {
        ...
        // Location codes are defined in 'Amicus.ini' file according to current
        // version (3.02)
     ...
     *
     * NOTE: This function needs to be modified only if Amicus has
    ...
    public function patronLogin($username, $password)
    {
        ...
        if ("$2a$" == substr($stored_hash, 0, 4)) {
            // Newer Amicus version that uses bcrypt
            $db_pwd = crypt($password, $stored_hash);
        } else {
            // Amicus used to use MD5_BASE64 encoding to save borrowers' passwords,
