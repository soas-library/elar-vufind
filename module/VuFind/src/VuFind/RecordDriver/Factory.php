...
class Factory
{
    ...
    /**
     * Factory for SolrCorpus record driver.
     *
     * @param ServiceManager $sm Service manager.
     *
     * @return SolrCorpus
     */
    public static function getSolrCorpus(ServiceManager $sm)
    {
        $driver = new SolrCorpus(
            $sm->getServiceLocator()->get('VuFind\Config')->get('config'),
            null,
            $sm->getServiceLocator()->get('VuFind\Config')->get('searches')
        );
    ...
    /**
     * Factory for SolrResource record driver.
     *
     * @param ServiceManager $sm Service manager.
     *
     * @return SolrResource
     */
    public static function getSolrResource(ServiceManager $sm)
    {
        $driver = new SolrResource(
            $sm->getServiceLocator()->get('VuFind\Config')->get('config'),
            null,
            $sm->getServiceLocator()->get('VuFind\Config')->get('searches')
        );
