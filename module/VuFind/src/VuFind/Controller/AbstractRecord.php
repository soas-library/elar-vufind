    ...
    public function emailAction()
    {
        ...
        if ($this->formWasSubmitted('submit', $view->useRecaptcha)) {
            ...
            try {
                ...
                $mailer->sendRecord(
                    $view->to, $view->from, $view->access, $view->datefrom, $view->dateto, $view->message, 
                    $view->userid, $view->userfirst, $view->userlast, $view->nodeid, $view->filename,$view->userfrom,
                    $driver, $this->getViewRenderer(), $view->subject, $cc
                );
                //SCB Add new parameters
