...
class Factory
{
    ...
    /**
     * SCB Construct the record stats helper.
     *
     * @param ServiceManager $sm Service manager.
     *
     * @return \VuFind\Statistics\Record
     */
    public static function getBrowseStats(ServiceManager $sm)
    {
        return new \VuFind\Statistics\Browse(
            $sm->get('VuFind\Config')->get('config'),
            $sm->get('VuFind\StatisticsDriverPluginManager'),
            $sm->get('VuFind\SessionManager')->getId()
        );
     ...
     * @return \VuFind\Statistics\Record
     */
    public static function getAlphabrowseStats(ServiceManager $sm)
    {
        return new \VuFind\Statistics\Alphabrowse(
            $sm->get('VuFind\Config')->get('config'),
            $sm->get('VuFind\StatisticsDriverPluginManager'),
            $sm->get('VuFind\SessionManager')->getId()
        );
    ...
    /**
     * SCB Construct the myresearch stats helper.
     *
     * @param ServiceManager $sm Service manager.
     *
     * @return \VuFind\Statistics\Record
     */
    public static function getMyresearchStats(ServiceManager $sm)
    {
        return new \VuFind\Statistics\Myresearch(
            $sm->get('VuFind\Config')->get('config'),
            $sm->get('VuFind\StatisticsDriverPluginManager'),
            $sm->get('VuFind\SessionManager')->getId()
        );
    ...
    /**
     * SCB Construct the map stats helper.
     *
     * @param ServiceManager $sm Service manager.
     *
     * @return \VuFind\Statistics\Map
     */
    public static function getMapStats(ServiceManager $sm)
    {
        return new \VuFind\Statistics\Map(
            $sm->get('VuFind\Config')->get('config'),
            $sm->get('VuFind\StatisticsDriverPluginManager'),
            $sm->get('VuFind\SessionManager')->getId()
        );
    ...
    /**
     * SCB Construct the publicstats stats helper.
     *
     * @param ServiceManager $sm Service manager.
     *
     * @return \VuFind\Statistics\Publicstat
     */
    public static function getPublicstatsStats(ServiceManager $sm)
    {
        return new \VuFind\Statistics\Publicstats(
            $sm->get('VuFind\Config')->get('config'),
            $sm->get('VuFind\StatisticsDriverPluginManager'),
            $sm->get('VuFind\SessionManager')->getId()
        );
