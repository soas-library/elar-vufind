...
class ILS extends AbstractBase
{
    ...
    public function authenticate($request)
    {
        ...
        if ($patron) {
            //SCB Store LOGIN statistic
            $table = $this->getDbTableManager()->get('UserStats');
            $table->insert(array( 'id' => uniqid('', true), 'browser' => ' ', 'browserVersion' => '0', 'ipaddress' => '127.0.0.0', 'referrer' => 'Authenticate', 'url' => 'Authenticate', 'session' => 'Authenticate', 'country' => '  ' ) );
    ...
    protected function processILSUser($info)
    {
        ...
        $fields = ['firstname', 'lastname', 'email', 'major', 'college', 'displayed'];
