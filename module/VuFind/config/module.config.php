...
$config = [
    ...
    'controllers' => [
        ...
        'invokables' => [
            ...
            //SCB Maps and Statistics
            'map' => 'VuFind\Controller\MapController',
            'statistics' => 'VuFind\Controller\StatisticsController',
            'publicstats' => 'VuFind\Controller\PublicStatsController',
            'uploadedfiles' => 'VuFind\Controller\UploadedFilesController',
            'uploadedfilesbyfiletype' => 'VuFind\Controller\UploadedFilesByFileTypeController',
            'downloadedfilesbyfiletype' => 'VuFind\Controller\DownloadedFilesByFileTypeController',
            //SCB Maps and Statistics
    ...
    'service_manager' => [
        ...
        'factories' => [
            ...
            //SCB New Stats
            'VuFind\BrowseStats' => 'VuFind\Service\Factory::getBrowseStats',
            'VuFind\AlphabrowseStats' => 'VuFind\Service\Factory::getAlphabrowseStats',
            'VuFind\MyresearchStats' => 'VuFind\Service\Factory::getMyresearchStats',
            'VuFind\MapStats' => 'VuFind\Service\Factory::getMapStats',
            'VuFind\PublicstatsStats' => 'VuFind\Service\Factory::getPublicstatsStats',
            //SCB New Stats
    ...
    'vufind' => [
        ...
        'plugin_managers' => [
            ...
            'recorddriver' => [
                ...
                'factories' => [
                    ...
                    'solrmarc' => 'VuFind\RecordDriver\Factory::getSolrMarc',
                     //SCB New record driver
                    'solrcorpus' => 'VuFind\RecordDriver\Factory::getSolrCorpus',
                    'solrresource' => 'VuFind\RecordDriver\Factory::getSolrResource',
                     //SCB New record driver
            ...
            'recordtab' => [
                ...
                'factories' => [
                    ...
                    //SCB documents
                    'documents' => array('VuFind\RecordTab\Factory', 'getDocuments'),
                    //SDB documents
        ...
        'recorddriver_tabs' => [
            ...
            //SCB New for Authority
            'VuFind\RecordDriver\SolrAuth' => array(
                'tabs' => array (
                    'Details' => 'StaffViewMARC',
                    //'Details' => 'StaffViewArray',
                    //'DescriptionAuth' => 'DescriptionAuth',
                    'Documents' => 'Documents'
            ...
            //SCB New RecordDriver
            'VuFind\RecordDriver\SolrCorpus' => [
                'tabs' => [
                    'Holdings' => 'HoldingsILS', 'Description' => 'Description',
                    'TOC' => 'TOC', 'UserComments' => 'UserComments',
                    'Reviews' => 'Reviews', 'Excerpt' => 'Excerpt',
            ...
            'VuFind\RecordDriver\SolrResource' => [
                'tabs' => [
                    'Holdings' => 'HoldingsILS', 'Description' => 'Description',
                    'TOC' => 'TOC', 'UserComments' => 'UserComments',
                    'Reviews' => 'Reviews', 'Excerpt' => 'Excerpt',
...
$dynamicRoutes = [
    'MyResearch' => ['userList' => 'MyList/[:id]', 'editList' => 'EditList/[:id]', 'resourceList' => 'Resource/[:id]' ],
    //SCB
    //Mirar arriba
...
//SCB Routes for deposit and resources
//$resourceRoutes = array('resourceList' => 'Resources');
//SCB Routes for deposit and resources
...
$staticRoutes = [
    ...
    'PublicStats/Home',
    'UploadedFiles/Home',
    'UploadedFilesByFileType/Home',
    'DownloadedFilesByFileType/Home',
    //SCB Maps and Statistics
