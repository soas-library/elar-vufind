function filterELARWebTrafficUploadbyfiletypeDeposit(deposit) {
    ...
    checkUploadFilesByFileType(yearFrom, monthFrom, dayFrom, yearTo, monthTo, dayTo,funding_body, current_superseded, deposit);
...
function checkUploadFilesByFileType (yearFrom, monthFrom, dayFrom, yearTo, monthTo, dayTo, funding_body, current_superseded,deposit) {

  var content = '';

  $.ajax({
    dataType: 'json',
    url: path + '/AJAX/JSON?method=getUploadFilesByFileTypeDeposit',
