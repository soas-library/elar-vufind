function filterELARWebTrafficGeneralPrivate() {
    ...
    document.getElementById("statisticsForm").action="PrivateStatsGeneral?yearFrom="+yearFrom+"&monthFrom="+monthFrom+"&dayFrom="+dayFrom+"&yearTo="+yearTo+"&monthTo="+monthTo+"&dayTo="+dayTo+"&source=ajax";
